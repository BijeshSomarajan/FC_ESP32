...
#define ATTITUDE_IMU_UPDATE_PERIOD_US (ATTITUDE_IMU_UPDATE_PERIOD * 1000000.0f)/8.0f

#define ATTITUDE_CONTROL_UPDATE_PERIOD SENSOR_GYRO_SAMPLE_PERIOD //1.0f/1000.0f
#define ATTITUDE_CONTROL_UPDATE_PERIOD_US  (ATTITUDE_CONTROL_UPDATE_PERIOD * 1000000.0f)/2.0f
