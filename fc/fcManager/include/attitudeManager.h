...
#define SENSOR_READ_NOISE_AND_ACC_TOGETHER 0
...
#define NOISE_SAMPLE_PERIOD_US SENSOR_ACC_SAMPLE_PERIOD * 1000000.0f
...
#define ATTITUDE_CONTROL_UPDATE_PERIOD SENSOR_GYRO_SAMPLE_PERIOD *1.0f
