...
#define MAHONY_BF_FILTER_BF_USE_TRIG_APPROX 0//Angle  flip issue
#define MAHONY_BF_FILTER_BF_USE_SQRT_APPROX 0

#define MAHONY_BF_FILTER_BF_FLOOR_ANGLES 0
//Higher value means less reliability on gyro
#define MAHONY_BF_FILTER_KP  1.0f * 0.25f//0.25f  //100.7f; //0.155f; //0.175f; //0.225 //0.125f; //0.235
